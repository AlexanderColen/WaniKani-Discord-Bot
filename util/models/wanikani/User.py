...
class User:
    def __init__(self, wk_id: str, username: str, profile_url: str, level: int, last_update: str, member_since: str,
                 subscribed: bool, subscription_type: str, max_level: int, on_vacation_since: str):
        self.id: str = wk_id
